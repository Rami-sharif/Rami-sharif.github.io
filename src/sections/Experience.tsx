...
const experiences: Experience[] = [
  {
    ...
    company: 'Network & Security Engineer — Telecommunications Sector (Confidential / NDA)',
    location: 'Remote',
    summary:
      'Leading the design and deployment of secure infrastructure for a distributed IoT ecosystem, spanning network perimeter, device identity, and centralized communication services.',
    bullets: [
    ...
    tags: ['pfSense', 'OpenVPN', 'EMQX', 'MQTT', 'mTLS', 'Step-CA', ' PKI', 'Docker', 'Python (paho-mqtt)'],
  },
  {
    ...
    summary:
      'Delivering managed security services to clients across on-premises, cloud, and hybrid environments, covering SOC operations, web application hardening, and incident response.',
    bullets: [
      ...
      'Designed and implemented secure network infrastructures, including firewalling, ACLs, and network segmentation, while enabling secure remote access using OpenVPN. Configured and managed pfSense and MikroTik devices to enforce access control policies and isolate critical services.',
      'Conducted secure code reviews and integrated DevSecOps controls (SAST, SCA, secrets scanning) into CI/CD pipelines, with ongoing tracking of vulnerabilities and remediation progress.',
